...
import Exams_And_Preparations.Java_OOP.SpaceStation.common.Command;
...
public class EngineImpl implements Engine {
    ...
    private String addPlanet(String[] data) {
        return data.length > 1 ? controller.addPlanet(data[0], Arrays.copyOfRange(data, 1, data.length)):
                controller.addPlanet(data[0]);
    }
