...
public class VendingMachine_07 {public static void main(String[] args) {
    ...
    //sumirane na parite vkarani v mashinata
    //samo 0.1, 0.2, 0.5, 1, and 2 coins
    //ako vkarat drugi pari razlichni ot gorniq red "Cannot accept {money}" + and not add it to the total money
    ...
    input = scanner.nextLine();
    //formatirane do vtoriq simvol
    //sledvashtite nqkolko reda shte se vuvejdat produkti DO komandata END
